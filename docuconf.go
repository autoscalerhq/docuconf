...
func (c *ConfBuilder) AddString(name string, description string) *ConfBuilder {
	...
	c.options = append(c.options, ConfOption{Name: name, Description: description, Type: "string"})
	return c
}
